...
import type { ProjectDashboard } from "@/lib/marcus/types";
...
export function ProjectRunsChart({ data }: { data: ProjectDashboard["consumption"] }) {
  return (
    <ChartContainer config={chartConfig} className="h-[280px] w-full" initialDimension={{ width: 800, height: 280 }}>
